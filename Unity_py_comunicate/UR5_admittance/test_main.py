...
class UrRobot():
    ...
    def get_current_pos(self):  # x, y, theta
    ...
    def grasp(self):
        self.operate_gripper(100)
        self.move_down()
        self.operate_gripper(0)
        self.move_up()
        return self.check_grasp()


def go_home():
    UrRobot.operate_gripper(100)
    UrRobot.move_to_tcp([-3, -260, 600, 0, 0, 0])
